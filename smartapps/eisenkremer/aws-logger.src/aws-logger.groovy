...
definition(
    name: "AWS-Logger",
    namespace: "eisenkremer",
    author: "Ben Ben",
    description: "Send all sensors events and stuff to AWS API",
    category: "My Apps",
    iconUrl: "http://cdn.device-icons.smartthings.com/Transportation/transportation7-icn.png",
    iconX2Url: "http://cdn.device-icons.smartthings.com/Transportation/transportation7-icn@2x.png",
    iconX3Url: "http://cdn.device-icons.smartthings.com/Transportation/transportation7-icn@3x.png") {
    appSetting "arn"
}
